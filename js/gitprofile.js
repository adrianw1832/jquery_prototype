$(document).ready(function() {
  ...
  $('.gitprofile').on('submit', function(e) {
    ...
    var access_token = gitToken // Replace this with a Github access token that you can generate as explained here https://help.github.com/articles/creating-an-access-token-for-command-line-use/
